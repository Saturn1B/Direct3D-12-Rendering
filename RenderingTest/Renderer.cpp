...
ID3D12Resource* renderTargets[frameBufferCount] = { nullptr };
ID3D12CommandAllocator* commandAllocator[frameBufferCount] = { nullptr };
ID3D12GraphicsCommandList* commandList = nullptr;
ID3D12Fence* fence[frameBufferCount] = { nullptr };
...
ID3D12Resource* constantBufferUploadHeaps[frameBufferCount] = { nullptr };
UINT8* cbvGPUAddress[frameBufferCount] = { nullptr };
